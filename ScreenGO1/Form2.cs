...
namespace ScreenGO1
{
    public partial class Form2 : Form
    {
        ...
        {
            DialogResult result = MessageBox.Show("Do you want to shutdown this computer now?", "ScreenGO1", MessageBoxButtons.YesNo, MessageBoxIcon.Information);
        ...
        {
            DialogResult result = MessageBox.Show("Do you want to add 5 more minutes?", "ScreenGO1", MessageBoxButtons.YesNo, MessageBoxIcon.Information);
